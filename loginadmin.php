...
include "db_connect.php"; // Corrected: Include database connection file
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        // Debugging: Check stored vs. entered password
        echo "Entered Password: " . $password . "<br>";
        echo "Stored Password: " . $admin['password'] . "<br>";

        // Ensure both passwords are treated as integers before comparison
        if ((int)$password === (int)$admin['password']) {
