...
define("ADMIN_SECRET_KEY", "MOHIT_2005"); // Move this to an environment variable for security
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$stmt) {
        die("<script>alert('Database Error: Unable to prepare statement.');</script>");
    }
